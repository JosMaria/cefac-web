  ...
  return (
    <section className={styles.messageContainer}>
      ...
      <div className={styles.dangerContainer}>
        ...
        <div className={styles.messageContent}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, excepturi deserunt id adipisci molestiae, rem illo expedita tenetur itaque quam tempora fugiat dolor quidem temporibus, eum sequi ullam doloribus ipsa?
        </div>
      </div>
    </section>
  );
